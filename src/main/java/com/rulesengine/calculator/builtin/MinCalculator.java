...
/**
 * Calculator that finds the minimum value among numeric fields
 */
@Component
public class MinCalculator extends AbstractFieldCalculator {
    ...
    public String getDescription() {
        return "Finds the minimum value among numeric field values";
    }
}